            ...
            <ul class="navbar-nav ml-auto mt-10">
              <li class="nav-item dropdown dropdown-slide">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  <a class="dropdown-item" href="login.php" method="POST">Login</a>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="content-block">
          <h1>RENT, SELL OR LEASE </h1>
          <p>Join the millions in finding affordable accommodation <br> at the comfort of your own home.</p>
          <div class="short-popular-category-list text-center">
            <h2>Categories</h2>
            <ul class="list-inline">
              <li class="list-inline-item">
                <a href=""><i class="fa fa-bed"></i> Flat</a>
              </li>
              <li class="list-inline-item">
                <a href=""><i class="fa fa-bed"></i> Room</a>
              </li>
              <li class="list-inline-item">
                <a href=""><i class="fa fa-bed"></i> Sublet</a>
              </li>
              <li class="list-inline-item">
                <a href=""><i class="fa fa-laptop"></i> Office</a>
              </li>
              <li class="list-inline-item">
                <a href=""><i class="fa fa-coffee"></i> Restaurant</a>
              </li>
            </ul>
          </div>
                  ...
                  <div class="card" style="width: 23rem;">
                    <div class="thumb-content">
                      ...
                      <a href="">
                        ...
                        <?php echo '<img value="$temp" src="'.$image_src2.'" width="368" height="368"/>' ?>
                      </a>
                    </div>
                    <div class="card-body">
